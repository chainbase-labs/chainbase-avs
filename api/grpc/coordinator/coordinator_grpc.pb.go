...
func (c *coordinatorServiceClient) ProcessSignedTaskResponse(ctx context.Context, in *SignedTaskResponseRequest, opts ...grpc.CallOption) (*SignedTaskResponseReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignedTaskResponseReply)
	err := c.cc.Invoke(ctx, CoordinatorService_ProcessSignedTaskResponse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CoordinatorService_ProcessSignedTaskResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignedTaskResponseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoordinatorServiceServer).ProcessSignedTaskResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoordinatorService_ProcessSignedTaskResponse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoordinatorServiceServer).ProcessSignedTaskResponse(ctx, req.(*SignedTaskResponseRequest))
	}
